...
class CustomerFollowUpAdmin(BaseAdmin):
    list_display = ('customer', 'consultant', 'date', "intention")
    list_filters = ["customer", "consultant", 'date', 'intention']
    search_fields = ['date', 'intention']


class UserProfileAdmin(BaseAdmin):
    list_display = ('email', 'name')
    list_filters = ["name", "roles"]
