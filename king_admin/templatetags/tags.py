...
def build_table_header_column(column, orderby_key, filter_condtions, admin_class):
    ...
    try:
        ...
        ele = '''<th><a href="javascript:void(0);">{column}</th>'''.format(column=column_verbose_name)
        return mark_safe(ele)
...
def get_m2m_obj_list(admin_class, field, form_obj):
    ...
    print("...........", field_obj.rel.model.objects.all(), dir(field_obj.rel.model))
...
@register.simple_tag
def test(obj):
    print("......", obj.roles, type(obj), dir(obj))
