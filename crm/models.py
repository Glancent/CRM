...
class Customer(models.Model):
    name = models.CharField(max_length=32, blank=True, null=True, help_text="用户报名后改名")
...
class ClassList(models.Model):
    ...
    contract = models.ForeignKey("ContractTemplate", blank=True, null=True, on_delete=callable)
...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    password = models.CharField(('password'), max_length=128, help_text=mark_safe('''<a href='password/'>修改密码</a>'''))
